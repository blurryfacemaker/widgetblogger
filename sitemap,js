/*
golodogudud.blogspot.com
var toc_config = {
	url: 'https://golodogudud.blogspot.com',
	containerId: 'table-of-content',
	showNew: 15,
	newText: ' <strong style="font-weight:normal;font-style:normal;color:#fff;font-size:11px;background:#5c5a78;padding:1px 6px 3px 6px;line-height:normal;float:right;border-radius:3px;"><a href="https://golodogudud.blogspot.com">baru</a></strong>',
	sortAlphabetically: {
		thePanel: true,
		theList: true
	},
